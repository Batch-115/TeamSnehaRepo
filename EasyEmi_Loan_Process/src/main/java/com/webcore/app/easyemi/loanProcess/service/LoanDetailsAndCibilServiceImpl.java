...
public class LoanDetailsAndCibilServiceImpl implements LoanDetailsAndCibilService{
	...
	public List<CustomerCibil> getCustomerCibilData() {
		List<CustomerCibil>list= (List<CustomerCibil>) cibilrepository.findAll();
		 return list;
	}
	...
	List<CustomerLoanDetails>list=(List<CustomerLoanDetails>) loandetailsrepository.findAll();
		 return list;
